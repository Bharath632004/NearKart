...
const MOCK_ORDERS = [
  {
    _id: "o1",
    customer: "Ravi Kumar",
    merchant: "Fresh Veggies",
    deliveryPartner: "Arun Kumar",
    amount: 350,
    status: "pending",
    date: "2026-07-01",
    refund: false,
    escalated: false,
    timeline: [
      { event: "Order Placed", time: "10:00 AM" },
      { event: "Confirmed", time: "10:05 AM" },
    ],
    items: [
      { name: "Tomatoes 1kg", qty: 2, price: 60 },
      { name: "Onions 1kg", qty: 1, price: 40 },
    ],
  },
  {
    _id: "o2",
    customer: "Priya Sharma",
    merchant: "Daily Dairy",
    deliveryPartner: "Vijay S",
    amount: 120,
    status: "delivered",
    date: "2026-06-30",
    refund: false,
    escalated: false,
    timeline: [
      { event: "Order Placed", time: "09:00 AM" },
      { event: "Delivered", time: "09:40 AM" },
    ],
  ...
  },
  {
    ...
    escalated: true,
    timeline: [
      { event: "Order Placed", time: "08:00 AM" },
      { event: "Cancelled", time: "08:15 AM" },
    ],
    items: [
      { name: "Rice 5kg", qty: 1, price: 300 },
      { name: "Oil 1L", qty: 2, price: 200 },
    ],
  },
  {
    _id: "o4",
    ...
    escalated: false,
    timeline: [
      { event: "Order Placed", time: "11:00 AM" },
      { event: "Out for Delivery", time: "11:30 AM" },
    ],
...
export default function Orders() {
  ...
  const assignDelivery = async () => {
    if (!assignPartner || !assignModal) return;
    try {
      await API.patch(`/admin/orders/${assignModal._id}/assign`, {
        partner: assignPartner,
      });
    } catch {}
    setOrders((prev) =>
      prev.map((o) =>
        o._id === assignModal._id ? { ...o, deliveryPartner: assignPartner } : o
      )
    );
  ...
  return (
    <div className="space-y-5">
      ...
      <Modal
        ...
        title={`Order #${selectedOrder?._id} Timeline`}
        size="md"
      >
        {selectedOrder && (
      ...
      >
        {refundModal && (
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                onClick={() => approveRefund(refundModal._id)}
