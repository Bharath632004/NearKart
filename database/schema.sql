...
CREATE INDEX idx_shops_location      ON shops USING GIST (ST_MakePoint(longitude, latitude)::geometry);
...
CREATE INDEX idx_delivery_assignments_partner_id ON delivery_assignments(partner_id);
...
CREATE UNIQUE INDEX idx_reviews_unique ON reviews(reviewer_id, entity_type, entity_id);
