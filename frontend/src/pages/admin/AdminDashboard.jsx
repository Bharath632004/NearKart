...
const styles = {
  ...
  sectionTitle:{ color: '#1a1a2e', marginTop: 32, marginBottom: 12 },
  grid:        { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 16, marginBottom: 8 },
  card:        { background: '#fff', borderRadius: 12, padding: 20, textAlign: 'center',
  ...
  navGrid:     { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16 },
  navCard:     { background: '#fff', borderRadius: 12, padding: 22, textAlign: 'center',
                 boxShadow: '0 2px 8px rgba(0,0,0,0.08)', textDecoration: 'none',
                 display: 'block', color: 'inherit' },
